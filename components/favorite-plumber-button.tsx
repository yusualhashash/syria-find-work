...
import { togglePlumberFavorite } from "@/lib/plumbers/plumbers-favorites-actions"



interface FavoritePlumberButtonProps {
    plumberId: string
    initialIsFavorited: boolean
    size?: "sm" | "md" | "lg"
}

export function FavoritePlumberButton({ plumberId, initialIsFavorited, size = "md" }: FavoritePlumberButtonProps) {
    ...
    const handleToggle = async (e: React.MouseEvent) => {
        ...
        startTransition(async () => {
            const result = await togglePlumberFavorite(plumberId);
            if (result.success) {
