...
import { toggleGermanTeacherFavorite } from "@/lib/german-teachers/german-teachers-favorites-actions"



interface FavoriteGermanTeacherButtonProps {
    teacherId: string
    initialIsFavorited: boolean
    size?: "sm" | "md" | "lg"
}

export function FavoriteGermanTeacherButton({ teacherId, initialIsFavorited, size = "md" }: FavoriteGermanTeacherButtonProps) {
    ...
    const handleToggle = async (e: React.MouseEvent) => {
        ...
        startTransition(async () => {
            const result = await toggleGermanTeacherFavorite(teacherId);
            if (result.success) {
