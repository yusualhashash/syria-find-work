...
export default function ElectricianTeachersClient({ initialTeachers }: { initialTeachers: ElectricianTeacherWithFavorite[] }) {
    const [searchTerm, setSearchTerm] = useState("")
    const [selectedCity, setSelectedCity] = useState<string | null>(null)
    const [allTeachers, setAllTeachers] = useState<ElectricianTeacherWithFavorite[]>(initialTeachers)
                    ...
                    <div className="flex items-center justify-between py-3">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className="text-xl md:text-2xl font-bold text-white"> معلمين كهرباء </h1>
                            </div>
                        </div>
                    </div>
                            ...
                            <Link key={teacher.id} href={`/electrician-teachers/${teacher.id}`} className="h-full">
                                <div className="bg-gray-900 border border-gray-700 rounded-none overflow-hidden transition-shadow h-full flex flex-col relative">
                                    <div className="absolute top-2 left-2 z-10">
                                        <FavoriteElectricianTeacherButton
