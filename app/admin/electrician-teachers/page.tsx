...
import ElectricianTeachersList from "./electrician-teachers-list"


export default async function AdminElectricianTeachersPage() {
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-1 sm:mb-2">
                                    ...
                                    <h1 className="text-md sm:text-xl font-bold text-gray-900">
                                        إدارة معلمين الكهرباء
                                    </h1>
                                </div>

                                <p className="text-sm sm:text-base text-gray-600">
                                    إضافة، تعديل وحذف معلومات المعلمين
                                </p>
                            </div>
                        </div>

                        <Link href="/admin/electrician-teachers/new" className="w-full sm:w-auto">
