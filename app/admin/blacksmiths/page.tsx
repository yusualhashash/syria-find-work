...
import BlacksmithsList from "./blacksmiths-list"


export default async function AdminBlacksmithsPage() {
                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm sm:text-base text-gray-600">
                                    إضافة، تعديل وحذف معلومات الحدادين
                                </p>
                            </div>
                        </div>

                        <Link href="/admin/blacksmiths/new" className="w-full sm:w-auto">
