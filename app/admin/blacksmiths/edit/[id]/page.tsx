...
import BlacksmithForm from "../../blacksmith-form"

export async function generateStaticParams() {
    return [{ id: "static-placeholder-id" }]
}

export default async function EditBlacksmithPage({
    params,
}: {
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-sm sm:text-base text-gray-600">
                                تحديث بيانات الحداد بشكل كامل
                            </p>
                        </div>
                    </div>

                    <BlacksmithForm blacksmith={blacksmith} />
                </div>
            </div>
        </div>
    )
