...
import PlumberForm from "../../plumber-form"

export async function generateStaticParams() {
    return [{ id: "static-placeholder-id" }]
}

export default async function EditPlumberPage({
    params,
}: {
