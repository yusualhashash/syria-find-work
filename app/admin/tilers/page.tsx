...
import TilersList from "./tilers-list"


export default async function AdminTilersPage() {
                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm sm:text-base text-gray-600">
                                    إضافة، تعديل وحذف معلومات المبلطين
                                </p>
                            </div>
                        </div>

                        <Link href="/admin/tilers/new" className="w-full sm:w-auto">
