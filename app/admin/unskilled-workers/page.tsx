...
import UnskilledWorkersList from "./unskilled-workers-list"


export default async function AdminUnskilledWorkersPage() {
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-1 sm:mb-2">
                                    ...
                                    <h1 className="text-md sm:text-xl font-bold text-gray-900">
                                        إدارة العمال من دون مهنة
                                    </h1>
                                </div>

                                <p className="text-sm sm:text-base text-gray-600">
                                    إضافة، تعديل وحذف معلومات العاملين
                                </p>
                            </div>
                        </div>

                        <Link href="/admin/unskilled-workers/new" className="w-full sm:w-auto">
