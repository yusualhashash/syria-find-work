...
import EnglishTeachersList from "./english-teachers-list"

export default async function AdminEnglishTeachersPage() {
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-1 sm:mb-2">
                                    ...
                                    <h1 className="text-md sm:text-xl font-bold text-gray-900">
                                        إدارة مدرسين اللغة الإنجليزية
                                    </h1>
                                </div>

                                <p className="text-sm sm:text-base text-gray-600">
                                    إضافة، تعديل وحذف معلومات المدرسين
                                </p>
                            </div>
                        </div>

                        <Link href="/admin/english-teachers/new" className="w-full sm:w-auto">
